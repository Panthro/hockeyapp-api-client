...
import com.github.panthro.auth.Authentication;
import com.github.panthro.auth.HttpBasicAuth;
import com.github.panthro.auth.ApiKeyAuth;
import com.github.panthro.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://rink.hockeyapp.net/api/2";
    ...
    public ApiClient() {
        ...
        authentications.put("token", new ApiKeyAuth("header", "X-HockeyAppToken"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://rink.hockeyapp.net/api/2
