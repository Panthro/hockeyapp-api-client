...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HockeyappPublicApiWrapper.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    ...
    describe('appsUploadPost', function() {
      it('should call appsUploadPost successfully', function(done) {
        //uncomment below and update the code to test appsUploadPost
        //instance.appsUploadPost(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
