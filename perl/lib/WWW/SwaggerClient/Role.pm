...
has version_info => ( is => 'ro', 
                      isa => 'HashRef', 
                      default => sub { {
                          app_name => 'Hockeyapp Public API wrapper',
                          app_version => '0.0.2',
                          generated_date => '2016-10-25T11:56:10.081Z',
...
=head2 Hockeyapp Public API wrapper version: 0.0.2
...
=item Build date: 2016-10-25T11:56:10.081Z
