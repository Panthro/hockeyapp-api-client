...
request_params('AppsGet') ->
    [
    ];

request_params('AppsUploadPost') ->
    [
        'Ipa',
        'dsym',
        'notes',
...
request_param_info('AppsUploadPost', 'Ipa') ->
    #{
        source =>   ,
        rules => [
            required
...
request_param_info('AppsUploadPost', 'dsym') ->
    #{
        source =>   ,
        rules => [
            not_required
...
request_param_info('AppsUploadPost', 'notes') ->
    #{
        source =>   ,
        rules => [
            {type, 'binary'},
...
request_param_info('AppsUploadPost', 'notes_type') ->
    #{
        source =>   ,
        rules => [
            {type, 'integer'},
...
request_param_info('AppsUploadPost', 'notify') ->
    #{
        source =>   ,
        rules => [
            {type, 'integer'},
...
request_param_info('AppsUploadPost', 'status') ->
    #{
        source =>   ,
        rules => [
            {type, 'integer'},
...
request_param_info('AppsUploadPost', 'strategy') ->
    #{
        source =>   ,
        rules => [
            {type, 'binary'},
...
request_param_info('AppsUploadPost', 'tags') ->
    #{
        source =>   ,
        rules => [
            not_required
...
request_param_info('AppsUploadPost', 'teams') ->
    #{
        source =>   ,
        rules => [
            not_required
...
request_param_info('AppsUploadPost', 'users') ->
    #{
        source =>   ,
        rules => [
            not_required
...
request_param_info('AppsUploadPost', 'mandatory') ->
    #{
        source =>   ,
        rules => [
            {type, 'integer'},
...
request_param_info('AppsUploadPost', 'release_type') ->
    #{
        source =>   ,
        rules => [
            {type, 'integer'},
...
request_param_info('AppsUploadPost', 'private') ->
    #{
        source =>   ,
        rules => [
            {type, 'boolean'},
...
request_param_info('AppsUploadPost', 'owner_id') ->
    #{
        source =>   ,
        rules => [
            {type, 'integer'},
...
request_param_info('AppsUploadPost', 'commit_sha') ->
    #{
        source =>   ,
        rules => [
            {type, 'binary'},
...
request_param_info('AppsUploadPost', 'build_server_url') ->
    #{
        source =>   ,
        rules => [
            {type, 'binary'},
...
request_param_info('AppsUploadPost', 'repository_url') ->
    #{
        source =>   ,
        rules => [
            {type, 'binary'},
...
validate_response('AppsGet', 200, Body, ValidatorState) ->
    validate_response_body('Apps', 'Apps', Body, ValidatorState);
validate_response('AppsGet', 400, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);

validate_response('AppsUploadPost', 201, Body, ValidatorState) ->
    validate_response_body('App', 'App', Body, ValidatorState);
validate_response('AppsUploadPost', 400, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
